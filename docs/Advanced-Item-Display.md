...
- AREAID: matches the id of the area the item is lying in (see [Area ids and area levels](#area-ids-and-area-levels))
- AREALVL: matches the monster level of that area for the current difficulty (see [Area ids and area levels](#area-ids-and-area-levels))
