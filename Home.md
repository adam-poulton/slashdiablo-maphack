...
* M81's Custom Config: [ [Wiki](https://github.com/youbetterdont/bhconfig/wiki/User-Guide) | [BH.cfg](https://github.com/youbetterdont/bhconfig/releases/latest/download/BH.cfg) | [BH_settings.cfg](https://github.com/youbetterdont/bhconfig/releases/latest/download/BH_settings.cfg) ] *(1.9.9 support still in [pre-release](https://github.com/youbetterdont/bhconfig/releases))*
